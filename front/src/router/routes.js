...
const routes = [
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'personals', component: () => import('pages/Personals.vue') },
      { path: 'registro-vacunas', component: () => import('pages/RegistroVacunas.vue') },
      { path: 'reporte-registro-vacunas', component: () => import('pages/ReporteRegistroVacunas.vue') },
      ...
      { path: 'procesos', component: () => import('pages/Procesos.vue') },
      ...
      { path: 'health-centers', component: () => import('pages/HealthCenters.vue') },
